...
public class Welcome {
   ...
   //   int choice = 0;
      ...
      while (!quit){
	   ...
	   /*System.out.println("***********************************************");
	   System.out.println(" 1. 고객 정보 확인하기 \t4. 장바구니에 항목 추가");
      System.out.println(" 2. 장바구니 상품 목록보기 \t5. 장바구니에 항목수량 줄이기");
      ...
      */
	   ...
	   menuIntroduction();
	   try {
       System.out.print("메뉴 번호을 선택해주세요 ");
       int n = input.nextInt();
          ...
          switch(n)
          {
             case 1:   //System.out.println("현재 고객 정보 : ");                       
                ...
                menuGuestInfo(userName, userMobile );
                       ...
                       break;
             case 2:   //System.out.println("장바구니 상품 목록 :"); 
                menuCartItemList();
                break;
             case 3:   //System.out.println("장바구니 비우기"); 
                menuCartClear();
                break;
             case 4:   //System.out.println("장바구니에 항목 추가 : "); 
               //menuCartAddItem(mBook);
            	 menuCartAddItem(mBookList); 
            	 
                break;        
                           
             case 5:   //System.out.println("5. 장바구니에 항목수량 줄이기");  
                menuCartRemoveItemCount();
                break;        
             
             case 6:   //System.out.println("6. 장바구니에 항목 삭제하기"); 
                menuCartRemoveItem();
                break;
             ...
             case 9:   //System.out.println("8. 종료"); 
                 menuAdminLogin();
	...
	public static void menuCartClear() throws CartException{
	 //  System.out.println("장바구니 비우기");
		if (mCart.mCartCount==0)  throw new CartException("장바구니에 항목이 없습니다");//System.out.println("장바구니에 항목이 없습니다"); 
		else {
...
/*	public static void menuCartAddItem(String[][] book){
	  // System.out.println("장바구니에 항목 추가 : ");
		 ...
		 boolean quit =false;
		  ...
		  while (!quit){
			  System.out.print("장바구니에 추가할 도서를 ID를 입력하세요 :"); 
	...
	*/
			...
			if(flag)  {
				...
				if (str.toUpperCase().equals("Y")) {						 
					...
					if (!isCartInBook(booklist[numId].getBookId())) {
						// mCartItem[mCartCount++] = new CartItem(book[numId]); //09
						// mCartItem[mCartCount++] = new CartItemBook(booklist[numId]); //09
	...
	public static void menuCartRemoveItemCount(){
	   System.out.println("5. 장바구니에 항목수량 줄이기");
	...
	/* 	public static void menuCartRemoveItem(){
	  ...
	  if (mCartCount==0)  System.out.println("장바구니에 항목이 없습니다"); 
	   else {
		   menuCartItemList();
		   boolean quit =false;
		   while (!quit){
				  System.out.print("장바구니에 삭제할 도서를 ID를 입력하세요 :"); 
				  Scanner input = new Scanner(System.in);  
				  String str = input.nextLine();
				  boolean flag = false;
				  int numId=-1;
				  ...
				  if(flag)  {
					  ...
					  str = input.nextLine();
					  if (str.toUpperCase().equals("Y")) {		
						  System.out.println(mCartItem[numId].getBookID() +  " 도서가 장바구니에 삭제되었습니다.");
						  //배열이동
	...
	public static void menuCartBill() throws CartException{
		  // System.out.println("7. 영수증 표시하기"); 
		   if(mCart.mCartCount==0) throw new CartException("장바구니에 항목이 없습니다"); //System.out.println("장비구니에 항목이 없습니다");
		   else {	
	...
	/*
	public static void BookList(String[][] book){	  		 //09
	...
	*/
	public static void BookList(Book[] booklist){	  	 //09
